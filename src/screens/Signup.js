...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch("https://food-delivery-app-backend-five.vercel.app/api/getlocation", {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://food-delivery-app-backend-five.vercel.app/api/createuser", {
      // credentials: 'include',
        ...
        <div className='container' >
          <form className='w-50 m-auto mt-5 border bg-dark border-success rounded' onSubmit={handleSubmit}>
            ...
            <div className="m-3">
              ...
              <input type="email" className="form-control" placeholder="Enter your Email Address" name='email' value={credentials.email} onChange={onChange} aria-describedby="emailHelp" />
            </div>
            <div className="m-3">
